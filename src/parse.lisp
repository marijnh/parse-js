...
(defun/defs parse-js* (stream &optional strict-semicolons)
  ...
  (def for-of (label init lhs)
    (let ((obj (progn (next) (expression))))
      (expect #\))
      (as :for-of init lhs obj (with-label-scope :loop label (statement)))))
